namespace MLSoftware.OTA
{
    ...
    public partial class InvBlockTypeMethodInfo
    {
        
        private BillingInstructionType _billingInstruction;
        ...
        public InvBlockTypeMethodInfo()
        {
            this._billingInstruction = new BillingInstructionType();
        }
        
        public BillingInstructionType BillingInstruction
        {
            get
            {
                return this._billingInstruction;
            }
            set
            {
                this._billingInstruction = value;
            }
        }
