...
namespace MLSoftware.OTA
{
    ...
    public partial class OTA_HotelRatePlanRSRatePlans
    {
        
        private List<HotelRatePlanType> _ratePlan;
        ...
        public OTA_HotelRatePlanRSRatePlans()
        {
            this._ratePlan = new List<HotelRatePlanType>();
        }
        
        [System.Xml.Serialization.XmlElementAttribute("RatePlan")]
        public List<HotelRatePlanType> RatePlan
        {
            get
            {
