namespace MLSoftware.OTA
{
    ...
    public partial class ImageDescriptionTypeImageFormat : ImageItemType
    {
        ...
        private string _dimensionCategory;
        
        private bool _isOriginalIndicator;
        ...
        public string DimensionCategory
        {
            get
            {
                return this._dimensionCategory;
            }
            set
            {
                this._dimensionCategory = value;
            }
        }
        ...
        public bool IsOriginalIndicator
        {
            get
            {
                return this._isOriginalIndicator;
            }
            set
            {
                this._isOriginalIndicator = value;
            }
        }
