...
namespace MLSoftware.OTA
{
    ...
    public partial class OTA_HotelBookingRuleNotifRQRuleMessages
    {
        ...
        private List<OTA_HotelBookingRuleNotifRQRuleMessagesRuleMessage> _ruleMessage;
        ...
        public OTA_HotelBookingRuleNotifRQRuleMessages()
        {
            this._ruleMessage = new List<OTA_HotelBookingRuleNotifRQRuleMessagesRuleMessage>();
        }
        
        [System.Xml.Serialization.XmlElementAttribute("RuleMessage")]
        public List<OTA_HotelBookingRuleNotifRQRuleMessagesRuleMessage> RuleMessage
        {
            get
            {
