...
namespace MLSoftware.OTA
{
    ...
    public partial class TravelerInfoSummaryTypePriceRequestInformationDiscountPricing
    {
        
        private List<TravelerInfoSummaryTypePriceRequestInformationDiscountPricingFlightReference> _flightReference;
        ...
        public TravelerInfoSummaryTypePriceRequestInformationDiscountPricing()
        {
            this._flightReference = new List<TravelerInfoSummaryTypePriceRequestInformationDiscountPricingFlightReference>();
        }
        
        [System.Xml.Serialization.XmlElementAttribute("FlightReference")]
        public List<TravelerInfoSummaryTypePriceRequestInformationDiscountPricingFlightReference> FlightReference
        {
            get
            {
