...
namespace MLSoftware.OTA
{
    ...
    public partial class CustomerTypeCustLoyalty
    {
        ...
        private CustomerTypeCustLoyaltyMemberPreferences _memberPreferences;
        
        private CustomerTypeCustLoyaltySecurityInfo _securityInfo;
        
        private List<CustomerTypeCustLoyaltySubAccountBalance> _subAccountBalance;
        ...
        public CustomerTypeCustLoyalty()
        {
            this._vendorCode = new List<string>();
            this._subAccountBalance = new List<CustomerTypeCustLoyaltySubAccountBalance>();
            this._securityInfo = new CustomerTypeCustLoyaltySecurityInfo();
            this._memberPreferences = new CustomerTypeCustLoyaltyMemberPreferences();
        }
        ...
        public CustomerTypeCustLoyaltyMemberPreferences MemberPreferences
        {
            get
            {
                return this._memberPreferences;
            }
            set
            {
                this._memberPreferences = value;
            }
        }
        ...
        public List<CustomerTypeCustLoyaltySubAccountBalance> SubAccountBalance
        {
            get
            {
                return this._subAccountBalance;
            }
            set
            {
                this._subAccountBalance = value;
            }
        }
