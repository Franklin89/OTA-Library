...
namespace MLSoftware.OTA
{
    ...
    public partial class OTA_HotelRateAmountNotifRQRateAmountMessages
    {
        ...
        private List<RateAmountMessageType> _rateAmountMessage;
        ...
        public OTA_HotelRateAmountNotifRQRateAmountMessages()
        {
            this._rateAmountMessage = new List<RateAmountMessageType>();
        }
        
        [System.Xml.Serialization.XmlElementAttribute("RateAmountMessage")]
        public List<RateAmountMessageType> RateAmountMessage
        {
            get
            {
                return this._rateAmountMessage;
            }
            set
            {
                this._rateAmountMessage = value;
            }
        }
