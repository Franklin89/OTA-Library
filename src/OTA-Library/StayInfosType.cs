...
namespace MLSoftware.OTA
{
    ...
    public partial class StayInfosType
    {
        
        private List<StayInfoType> _stayInfo;
        ...
        public StayInfosType()
        {
            this._stayInfo = new List<StayInfoType>();
        }
        
        [System.Xml.Serialization.XmlElementAttribute("StayInfo")]
        public List<StayInfoType> StayInfo
        {
            get
            {
                return this._stayInfo;
            }
            set
            {
                this._stayInfo = value;
            }
        }
